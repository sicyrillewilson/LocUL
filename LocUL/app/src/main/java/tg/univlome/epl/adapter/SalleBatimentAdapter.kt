...
import tg.univlome.epl.ui.home.ViewAllSalleActivity

/**
 * Adapter SalleBatimentAdapter : Aperçu limité des salles avec navigation
 *
 * Description :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is SalleViewHolder && position < minOf(salles.size, min)) {
            ...
            holder.btnVoirTout.setOnClickListener {
                ...
                val intent = Intent(context, ViewAllSalleActivity::class.java).apply {
                    putExtra("salles", ArrayList(salles))
                }
